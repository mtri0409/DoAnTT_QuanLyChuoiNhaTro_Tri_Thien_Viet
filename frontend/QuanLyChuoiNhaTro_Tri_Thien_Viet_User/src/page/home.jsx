...
export default function Home() {
  ...
  const fetchRooms = useCallback(() => {
    ...
    setPage(0);
    userService
      .getAllRooms(0, FETCH_SIZE, "roomName", "asc", activeBranchId)
      .then((res) => setAllRooms(Array.isArray(res.content) ? res.content : []))
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
          ...
          <section>
            ...
            {!loadingRooms && error && (
              <div style={{ textAlign: "center", padding: 48 }}>
                ...
                <button onClick={fetchRooms} style={solidBtn}>
                  Thử lại
                </button>
              </div>
            )}
          ...
          {/* ── Divider ── */}
          <div style={{ borderTop: "2px dashed #e2e8f0", paddingTop: 8 }} />
        ...
        >
              ...
              {[2, 4, 6, 8, 10, MAX_PRICE].map((val) => (
                <button
                  ...
                  style={{
                    ...
                    fontFamily: "inherit",
                    fontWeight: maxPrice === val ? 600 : 500,
                    cursor: "pointer",
                  }}
                >
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "9px 0",
                      borderBottom:
                        i < amenities.length - 1 ? "1px solid #e2e8f0" : "none",
                      cursor: "pointer",
                      fontSize: 14,
          ...
          {/* Info card for posts section */}
          <div style={filterCard}>
            <div style={filterTitle}>💡 Tìm bạn ghép phòng</div>
            <p
              style={{
                fontSize: 13,
                color: "#64748b",
            ...
            >
              Bảng tin của các thành viên đang thuê phòng muốn tìm bạn ghép. Bấm
              vào bài đăng để xem thông tin và liên hệ.
            </p>
          </div>
