...
export default function RoomDetail() {
  ...
  useEffect(() => {
    ...
    const fetchRelatedByBranch = async () => {
      try {
        ...
        const currentFloor = allFloors.find(
          (f) => f.floorId === room.floorId
        );
        ...
        // ── Bước 2: Tìm tất cả floorId cùng branchId ──
        const floorIdsInSameBranch = allFloors
          .filter((f) => f.branchId === targetBranchId)
          .map((f) => f.floorId);

        console.log('=== Floor IDs in same branch ===', floorIdsInSameBranch);
        ...
        console.error('Fetch related rooms error:', err);
  ...
  const roomFloor = room.floorId ?? room.floor ?? null;
    ...
    <div style={styles.pageWrap}>
      <div style={{ maxWidth: 1120, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 13, color: '#94a3b8' }}>
              Danh sách phòng / <span style={{ color: '#475569' }}>Chi tiết</span>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={styles.card}>
              <div style={{
                ...
                borderRadius: 16, overflow: 'hidden', background: '#e2e8f0',
              }}>
                <img
                ...
                {images.length > 1 && (
                  <>
                    <button
                      ...
                      style={styles.galleryArrow('left')}
                    >‹</button>
                    <button
                      onClick={() => setActiveImg((i) => (i + 1) % images.length)}
                      style={styles.galleryArrow('right')}
                    >›</button>
                  </>
                )}
                    ...
                    {images.map((_, i) => (
                      <div
                        ...
                        style={{
                          ...
                          boxShadow: i === activeImg ? '0 0 6px rgba(0,0,0,0.3)' : 'none',
                        }}
                      />
                    ))}
                  </div>
                  ...
                  {images.map((img, i) => (
                    <img
                      ...
                      style={{
                        ...
                        transition: 'all 0.2s',
                        boxShadow: i === activeImg ? '0 0 0 2px rgba(59,130,246,0.3)' : 'none',
                      }}
                    />
                  ))}
                </div>
              ...
              <div style={{
                ...
                {roomDeposit && (
                  <div style={{
                    ...
                    <div style={{ fontSize: 11, color: '#94a3b8', fontWeight: 600 }}>ĐẶT CỌC</div>
            ...
            <div style={{
              ...
              {roomFloor && <StatCard emoji="🏢" label="Tầng" value={`Tầng ${roomFloor}`} />}
            ...
            {roomDesc && (
              <div style={styles.card}>
                ...
                <p style={{
                  margin: 0, color: '#475569', lineHeight: 1.8,
                  fontSize: 15, whiteSpace: 'pre-line',
                }}>
                  {roomDesc}
                </p>
              </div>
          ...
          <div style={{
              ...
              <div style={{ marginBottom: 18 }}>
                ...
                <div style={{
                  ...
                  <a
                    ...
                    style={{
                      color: '#fff', fontWeight: 700, fontSize: 18, flex: 1,
              ...
              <div>
                ...
                <a
                  ...
                  style={{
                    ...
                    gap: 8, background: '#fff', color: '#0068ff',
                ...
                <div style={{
                  marginTop: 8, color: 'rgba(255,255,255,0.5)', fontSize: 11,
                  textAlign: 'center',
                }}>
            ...
            <div style={{ ...styles.card, padding: '20px 22px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                ...
                {roomFloor && <SummaryRow label="Tầng" value={`Tầng ${roomFloor}`} />}
                ...
                {roomDeposit && <SummaryRow label="Đặt cọc" value={fmt(roomDeposit)} highlight />}
            ...
            <div style={{
              ...
              {['Giá cả minh bạch', 'Hỗ trợ 24/7', 'Không phí trung gian', 'Xem phòng miễn phí'].map((t, i) => (
                <div key={i} style={{
                  ...
                  padding: '6px 0', fontSize: 13, color: '#78350f',
                }}>
                  <span style={{
                    width: 20, height: 20, borderRadius: '50%',
                    background: '#fbbf24', color: '#fff', fontSize: 11,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        {loadingRelated && (
          <div style={{ marginTop: 48, marginBottom: 40 }}>
            ...
            <div style={{
              ...
              {[1, 2, 3, 4].map((i) => (
                <div key={i} style={{ ...styles.skeleton, height: 340, borderRadius: 18 }} />
              ))}
            </div>
          </div>
        )}
        ...
        {!loadingRelated && relatedRooms.length > 0 && (
          <div style={{ marginTop: 48, marginBottom: 40 }}>
            ...
            <div style={{
              ...
              <div>
                <h2 style={{ margin: 0, fontSize: 22, fontWeight: 800, color: '#0f172a' }}>
                  🏠 Phòng cùng chi nhánh
                </h2>
                <p style={{ margin: '4px 0 0', color: '#64748b', fontSize: 14 }}>
                  {relatedRooms.length} phòng khác tại{' '}
                  <span style={{ color: '#1d4ed8', fontWeight: 600 }}>{branchName}</span>
                </p>
              </div>
              <button
                onClick={() => navigate(-1)}
            ...
            <div style={{
              ...
              {relatedRooms.map((r) => (
                <RoomGridCard key={r.roomId} room={r} />
              ))}
            </div>
          </div>
        )}
        ...
        {!loadingRelated && relatedRooms.length === 0 && room && (
          <div style={{
            marginTop: 48, marginBottom: 40, textAlign: 'center',
            background: '#fff', borderRadius: 18, padding: '40px 20px',
