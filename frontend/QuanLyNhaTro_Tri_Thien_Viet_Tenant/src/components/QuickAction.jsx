...
const QuickActions = () => {
  const actions = [
    { icon: <FaUserCircle />, label: 'Thông tin cá nhân', color: 'primary' },
    { icon: <FaBed />, label: 'Thông tin phòng', color: 'success' },
    { icon: <FaHistory />, label: 'Lịch sử hóa đơn', color: 'info' },
    { icon: <FaFileContract />, label: 'Xem hợp đồng', color: 'warning' },
