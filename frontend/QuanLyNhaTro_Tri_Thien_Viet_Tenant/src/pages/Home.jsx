  ...
  if (!profile) {
    return (
      <div className="alert alert-warning m-4 rounded-4 shadow-sm border-0">
        ...
        Hồ sơ của bạn hiện chưa được khởi tạo. Vui lòng liên hệ quản lý chuỗi nhà trọ để được hỗ trợ.
      </div>
    );
  }
  ...
  return (
    <div className="home-container animate__animated animate__fadeIn py-2">
      ...
      <div className="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h4 className="fw-bold text-dark mb-0 text-uppercase tracking-wider">Cổng thông tin người thuê</h4>
          <p className="text-muted small mb-0">Hệ thống Quản lý Chuỗi Nhà trọ - <span className="text-primary fw-bold">TRI PHAM</span></p>
        </div>
      ...
      <footer className="mt-5 pt-4 text-center text-muted small border-top">
         &copy; {new Date().getFullYear()} - Hệ thống Quản lý Nhà trọ Trí Thiên Việt
      </footer>
    </div>
  );
};
