    ...
    <>
      ...
      <div className="container-fluid py-4 cc-root-font">
        ...
        <div className="d-flex align-items-center gap-3 mb-4">
          ...
          <div>
            <h4 className="fw-bold text-uppercase mb-0">Thêm chi nhánh</h4>
            <p className="text-muted small mb-0">Quản lý hệ thống chuỗi phòng trọ</p>
          </div>
        </div>
              ...
              <div className="card border-0 shadow-sm rounded-4 p-4 h-100">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    placeholder="VD: Chi nhánh Quận 9"
