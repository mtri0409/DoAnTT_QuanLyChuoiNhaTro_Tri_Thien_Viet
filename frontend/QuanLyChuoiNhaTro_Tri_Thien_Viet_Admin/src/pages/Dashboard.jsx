...
const Dashboard = () => {
  ...
  const recentActivities = [
    {
      id: 1,
      task: "Thanh toán hóa đơn P.101",
      time: "5 phút trước",
      status: "Thành công",
    },
    {
      id: 2,
      task: "Hợp đồng mới - Nguyễn Văn A",
      time: "1 giờ trước",
      status: "Chờ duyệt",
    },
    {
      id: 3,
      task: "Báo hỏng điện P.305",
      time: "3 giờ trước",
      status: "Đang xử lý",
    },
  ];
    ...
    <div className="container-fluid p-0">
      <div className="mb-4">
        ...
        <p className="text-muted small">
          Chào mừng Tri, đây là báo cáo nhanh tình hình kinh doanh hôm nay.
        </p>
      </div>
      ...
      <div className="row g-4">
        ...
        <div className="col-md-7">
          <div className="card border-0 shadow-sm h-100">
            ...
            <div className="card-body">
              {["Quận 1", "Thủ Đức", "Bình Thạnh", "Quận 7"].map(
                (branch, idx) => (
