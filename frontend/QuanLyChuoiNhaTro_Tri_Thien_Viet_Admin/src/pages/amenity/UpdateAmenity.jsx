  ...
  return (
    <div className="container-fluid py-4">
      ...
      <div className="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
          <h4 className="fw-bold text-uppercase mb-0">Cập nhật tiện ích</h4>
          <p className="text-muted small mb-0">
            Chỉnh sửa thông tin tiện ích
          </p>
        </div>
      </div>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-7">
            <div className="card border-0 shadow-sm rounded-4 p-4 h-100 d-flex justify-content-center align-items-center text-center">
              ...
              <h5 className="fw-bold">Cập nhật tiện ích</h5>
              <p className="text-muted small mb-0">
                Chỉnh sửa tên và icon tiện ích trong hệ thống
              </p>
