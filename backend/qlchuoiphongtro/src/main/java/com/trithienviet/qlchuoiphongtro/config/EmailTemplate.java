...
public class EmailTemplate {
    ...
    public static String getContractCreatedSuccess(String fullname, String roomName, String startDate,String endDate, String depositAmount) {
        return "<div style='max-width: 600px;'>" +
            ...
            "        <tr><td style='color: #666;'>Tiền cọc đã đóng:</td><td style='color: #2e7d32;'><b>" + depositAmount + " VNĐ</b></td></tr>" +
            "      </table>" +
            "    </div>" +
            "    " +
            ...
            "      <a href='http://localhost:3000/my-contract' style='" + BUTTON_STYLE + "'>Xem chi tiết hợp đồng</a>" +
            "    </div>" +
            "    " +
    ...
    public static String getContractExpired(String userName, String roomName, String endDate) {
        return "<div style='max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; border: 1px solid #ffcdd2; border-radius: 8px; overflow: hidden;'>" +
            ...
            "  <div style='padding: 30px; line-height: 1.6; color: #333;'>" +
            "    <p>Chào <b>" + userName + "</b>,</p>" +
            "    <p>Ban quản lý xin thông báo hợp đồng thuê <b>Phòng " + roomName + "</b> của bạn đã chính thức <b>hết hạn</b> vào ngày " + endDate + ".</p>" +
            "    " +
